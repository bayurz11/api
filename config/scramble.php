...
RESTO POS API documentation for local development and endpoint testing.

Available starter flows:

- Health check
- Authentication with Sanctum bearer token using username
- Dashboard summary

Use the `POST /api/v1/auth/login` endpoint with `username` and `password`, then send the returned bearer token for protected routes.
MARKDOWN,
    ],

    'ui' => [
        'title' => 'RESTO POS API Docs',
    ],
